...
public abstract class APIAccess {
    protected Map<String, String> apiHeaders;
    ...
    public void setApiHeader(String header, String value) {
        if (value != null && !Strings.isEmptyOrWhitespace(value)) {
            if (apiHeaders == null)
                apiHeaders = new HashMap<>();
            apiHeaders.put(header, value);
        }
    }
        ...
        try {
            if (queryParams != null) {
                ...
                for (Map.Entry<String, String> entry: queryParams.entrySet()) {
                    ...
                    //Encode a key=value parameter.
                    urlParams.append(prefixDelim + URLEncoder.encode(entry.getKey(), "utf-8"));
